// app/educacion/page.tsx (o finanzas/page.tsx)
"use client";
      ...
      <div className="relative w-full max-w-2xl bg-white/4 backdrop-blur-2xl border border-white/15 p-12 rounded-[3.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] text-center space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl md:text-5xl font-black tracking-tight uppercase text-white">
            Módulo en <span className="text-transparent bg-clip-text bg-linear-to-r from-gster-amarillo to-emerald-400">Desarrollo</span>
          </h1>
          <p className="text-gray-400 text-sm md:text-base max-w-lg mx-auto leading-relaxed font-medium">
            Este espacio se encuentra reservado bajo estrictos estándares de ingeniería y diseño para las futuras operaciones corporativas de <strong className="text-white">GSTER LLC</strong>.
          </p>
        </div>
        ...
        <div className="bg-white/3 border border-white/10 p-5 rounded-2xl flex items-center gap-4 text-left">
          ...
          <div>
            <h4 className="text-xs font-bold text-white uppercase tracking-wider">Acceso Exclusivo y Seguro</h4>
